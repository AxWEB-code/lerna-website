export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center bg-[#1F1F1F] text-white overflow-hidden hero-grid animated-bg">
      ...
      {/* glow background - changed to blue */}
      <div className="absolute top-40 right-40 w-[480px] h-[480px] bg-[#3B71E8] blur-[180px] opacity-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="hero-text">
          ...
          <span className="bg-[#3B71E8]/20 text-[#3B71E8] px-3 py-1 rounded-full text-xs">
        ...
        <div className="relative">
          ...
          {/* dashboard */}
          <div className="relative transform md:rotate-[-5deg] rounded-2xl border border-gray-800 bg-[#1F1F1F] shadow-2xl">
          ...
          <div className="hidden md:block absolute left-[-30px] top-[110px] bg-[#1F1F1F] border border-gray-700 p-3 rounded-lg shadow-xl w-44 float-card">
          ...
          <div className="hidden md:block absolute right-[-30px] top-[40px] bg-[#1F1F1F] border border-gray-700 p-3 rounded-lg shadow-xl w-44 float-card">
          ...
          <div className="hidden md:block absolute left-[10px] bottom-[10px] bg-[#1F1F1F] border border-gray-700 p-3 rounded-lg shadow-xl w-44 float-card">
          ...
          <div className="hidden md:block absolute right-[10px] bottom-[0px] bg-[#1F1F1F] border border-gray-700 p-3 rounded-lg shadow-xl w-44 float-card">
